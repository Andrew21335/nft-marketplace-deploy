...
import ModalWindow from "components/ui/modalwindow.js"
        ...
        <div className="flex-1">
            <div className="flex justify-between items-center">
              <div className="flex items-center mt-2">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Автор</p>
        ...
        <div className="overflow-hidden mb-4">
          <dl className="-mx-4 -mt-4 flex flex-wrap">
            <div className="flex flex-col px-4 pt-4">
              <dt className="order-2 text-sm font-medium text-gray-500">Стоимость</dt>
